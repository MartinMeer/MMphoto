  ...
  const testimonials: Testimonial[] = [
    {
      ...
      rating: 5,
      text: "Анна - истинный мастер своего дела. Наша семейная фотосессия превратилась в настоящий праздник. Каждый кадр пропитан теплотой и любовью. Дети чувствовали себя как в сказке, а результат превзошел все наши ожидания.",
    ...
    },
    {
      ...
      rating: 5,
      text: "Наше венчание было запечатлено с необычайной деликатностью и художественным вкусом. Анна смогла передать всю торжественность и святость момента. Эти фотографии стали настоящей семейной реликвией.",
    ...
    },
    {
      ...
      rating: 5,
      text: "Фотосессия в ожидании малыша стала одним из самых волнительных событий. Анна создала атмосферу невероятной нежности и красоты. Каждый снимок - это произведение искусства, полное материнской любви.",
    ...
    },
    {
      ...
      rating: 5,
      text: "Индивидуальная съемка для обновления портфолио превзошла все ожидания. Анна обладает уникальным даром видеть красоту в каждом человеке. Профессионализм высочайшего класса и безупречный вкус.",
    ...
    },
    {
      ...
      rating: 5,
      text: "Выбор фотографа для семейной съемки был очень важным для нас. Анна оказалась именно тем художником, который смог передать душу нашей семьи. Работает с особым трепетом и вниманием к деталям.",
      service: "Семейная фотосессия",
      date: "Август 2024"
    }
  ];
